var FiguraVista = function(padreDom, nombre) {
    if (padreDom) {
		...
		this.tridim = CreadorDOM.addInput(this.formCalc, "Fondo", "tridim");
        ...
        CreadorDOM.addButton(this, " Calcular Perímetro " + nombre, this.pulsarCalcularPerimetro);
		CreadorDOM.addButton(this, " Calcular Volumen " + nombre, this.pulsarCalcularVolumen);
    }
}
...
FiguraVista.prototype.pulsarCalcularVolumen = function() {
    this.controlador.calculaVolumen(parseInt(this.alto.value), parseInt(this.ancho.value), parseInt(this.tridim.value));
}
